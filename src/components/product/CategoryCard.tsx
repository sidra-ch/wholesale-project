    ...
    >
      ...
      >
        <div className="relative aspect-[4/3] overflow-hidden">
          <Image
            src={cloudinaryUrl(category.image, { width: 600, height: 450, crop: "fill" })}
            alt={category.name}
            fill
          ...
          <div className="absolute inset-0 p-6 flex flex-col justify-end">
            <div className="flex items-end justify-between">
              <div>
                <h3 className="font-bold text-white text-xl mb-1 group-hover:translate-y-0 transition-transform duration-300">
                  {category.name}
                </h3>
