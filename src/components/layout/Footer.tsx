        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10">
          ...
          <div className="col-span-full lg:col-span-1">
            ...
            <div className="flex gap-2.5">
              <a href="#" className="w-9 h-9 bg-white/[0.06] border border-white/[0.08] rounded-xl flex items-center justify-center hover:bg-candy hover:text-white hover:border-candy transition-all text-white/40 hover:scale-110" aria-label="facebook">
              ...
              <a href="#" className="w-9 h-9 bg-white/[0.06] border border-white/[0.08] rounded-xl flex items-center justify-center hover:bg-candy hover:text-white hover:border-candy transition-all text-white/40 hover:scale-110" aria-label="instagram">
              ...
              <a href="#" className="w-9 h-9 bg-white/[0.06] border border-white/[0.08] rounded-xl flex items-center justify-center hover:bg-candy hover:text-white hover:border-candy transition-all text-white/40 hover:scale-110" aria-label="whatsapp">
              ...
              <a href="#" className="w-9 h-9 bg-white/[0.06] border border-white/[0.08] rounded-xl flex items-center justify-center hover:bg-candy hover:text-white hover:border-candy transition-all text-white/40 hover:scale-110" aria-label="youtube">
